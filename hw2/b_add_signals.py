...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(
            lambda: self.plainTextEditLog.setPlainText(
                self.comboBox.currentText()
            )
        )
        self.pushButtonLineEdit.clicked.connect(self.onPushButtonLineEditClicked)
        self.pushButtonTextEdit.clicked.connect(self.onPushButtonTextEdit)
        ...
        self.pushButtonClearLog.clicked.connect(
            lambda: self.plainTextEditLog.clear()
        )
    ...
    def onPushButtonTextEdit(self):
        """
        Обработка сигнала clicked для TextEdit
    ...
    def onPushButtonPlainTextEdit(self):
        """
        Обработка сигнала clicked для PlainTextEdit
